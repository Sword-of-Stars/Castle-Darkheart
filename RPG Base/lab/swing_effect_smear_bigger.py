...
class Sword(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.smear_1 = load_pixel_image("data/smear_12.png")
        ...
        self.swing_angle_change = 140
        self.swing_angle_corrective_factor = 80
        self.angle_offset = 50
    ...
    def swing(self):
        if self.swing_cooldown <= 0:
            ...
            self.angle_relative_to_body = bound_angle(self.angle_relative_to_body)
            print(self.angle_relative_to_body)
    ...
    def get_side(self, factor=0):
        if self.angle_relative_to_body > 90 and self.angle_relative_to_body < 270:
            self.side = 'right'
            self.angle_relative_to_body -= self.angle_offset

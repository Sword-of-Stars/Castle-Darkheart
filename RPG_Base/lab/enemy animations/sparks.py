...
class Spark():
    ...
    def calculate_movement(self, dt=1):
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == KEYDOWN:
            ...
            if event.button == 1:
                for i in range(10):
                    sparks.append(Spark([mx+i, my], math.radians(random.randint(0,360)), random.randint(3, 6), (255, 255, 255), 5))
                    #sparks.append(Spark([mx+i*10, my], math.radians(270+15*i+random.randint(-5,5)), random.randint(1, 3), (255, 255, 255), 4))

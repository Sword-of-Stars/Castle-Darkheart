...
class Sword(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.normal_sword = load_pixel_image("data/sword_2.png")
        #self.smear_1 = load_pixel_image("data/smear_6.png")
        #self.smear_2 = load_pixel_image("data/smear_8.png")
        self.swing_image = load_pixel_image("data/sword_3.png")
        self.image = self.normal_sword
